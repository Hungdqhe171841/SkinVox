...
async function testAdminUploadAPINew() {
  try {
    console.log('🔍 Testing Admin Upload API with new configuration...\n');

    const API_URL = 'https://skinvox-backend.onrender.com';
    
    // Get a test image file
    const testImagePath = path.join(__dirname, '../public/uploads/admins/admin/blogs/z7150284395517_fbe9a08cac06ff4acce58bdcf2ecdbef.jpg');
